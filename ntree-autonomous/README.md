...
- `init_engagement()` - Initialize pentest engagement
...
Claude: "I'll initialize the engagement and scan the network"
  → Calls: init_engagement(scope_file)
...
Claude: "All hosts tested. Generating reports..."
  → Calls: score_risk(engagement_id)
...
# View engagement
cd ~/ntree/engagements/eng_20260109_120000/
ls findings/
ls reports/
cat state.json
```
...
4. ✅ Review: `cat ~/ntree/engagements/eng_*/reports/*.html`
